...
\section{Profile}
	...
	With more than five years of experience in solving scientific problems with programming and half of a year on a junior backend developer position he proved to be able to quickly adapt and learn new technologies.
	...
	He tackled a lot of data engineering and data science tasks such as data aggregation, processing and visualization using production grade technological stack including Python, Flask, Apache Airflow, Docker, Docker Compose and PostgreSQL.
...
\section{Education}
	...
	\vspace{-0.05cm}
	\cvitem{Thesis title}{Seismic noise analysis for purpose of Active Layer of Permafrost investigations in a region of Polish Polar Station in Hornsund, Svalbard}
	\vspace{-0.05cm}
