...
\photo[64pt][0.4pt]{profile_140_140.jpg}                       % optional, remove / comment the line if not wanted; '64pt' is the height the picture must be resized to, 0.4pt is the thickness of the frame around it (put it to 0pt for no frame) and 'picture' is the name of the picture file
...
% \section{Profile}
	...
	% With more then five years of experience in solving scientific problems using my programming skills I learned how to apply good programming practice in a world of scientific programming.
	% I have experience in working on all stages of scientific projects from sensor installation through data acquisition and processing up to result interpretation.
...
\section{Work Experience}
	\cventry{Oct 2017 -- Apr 2021}{Research engineer}{Institut de Physique du Globe de Strasbourg}{ Universite de Strasbourg}{}{}
	...
	\vspace{-0.05cm}
	\cvitem{Tech stack}{Python (Obspy, Numpy, Matplotlib, Scipy), Apache Airflow, Flask, Dask, Pytest, PostgreSQL, Docker, Jupyter, GitlabCI, AWS;}
...
\section{Programming}
	...
	\cvitem{Continous Intergration}{GitlabCI, GitHub Actions, TravisCI, CircleCI}
...
\section{Personal interests}
	\cvlistitem{Mountain biking, hiking, running, swimming}
