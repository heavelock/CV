...
\section{Work Experience}
	...
	\cvitem{Project}{Monitoring of deep reservoirs with Ambient Seismic Noise in collaboration with industrial partners from Storengy SAS. Project supervised by Jérôme Vergne (IPGS), Jean Schmittbuhl (IPGS), Alexandre Kazanstsev (Storengy). }
	\cvitem{Main tasks}{Design and development of a application for processing continuous seismic signal, data management and parameter extraction for ASN monitoring. Creating a data pipelines for continous data fetching and processing with Apache Airflow. Installation and maintenance of two broadband seismic network using Nanometrics and Guralp equipment with GSM connection. }
	\vspace{-0.1cm}
	\cvitem{Tech stack}{Python (Obspy, Numpy, Matplotlib, Scipy), Apache Airflow, Flask, Dask, Pytest, PostgreSQL, Docker, Jupyter}\vspace{-0.05cm}
	
	\vspace{0.1cm}
	\cvitem{Project}{Refactoring of legacy Fortran application for pattern matching and modernization by designing and building Python API. Project supervised by Sophie Lambotte (IPGS) and Olivier Lengline (IPGS). }
	\cvitem{Main tasks}{Refactoring of legacy Fortran application. Designing and building Python wrapper and API with Cython. Building Continous Intergration pipelines.}
	\vspace{-0.1cm}
	\cvitem{Tech stack}{Python (Obspy, Numpy, Matplotlib, Scipy), Cython,  Pytest, Jupyter, Docker}

	\vspace{0.2cm}
	\cventry{Apr 2017 -- Sep 2017}{Junior Java Developer}{ACC Cyfronet AGH}{}{}{}
	\vspace{-0.05cm}
	\cvitem{Responsibilities}{Backend development of IS-EPOS online scientific platform. Developing seismological data processing scripts.}
	\vspace{-0.1cm}
	...
	\vspace{-0.05cm}
	\cvitem{Responsibilities}{Seismic data processing for purpose of HVSR method. Creating and maintaining database of PGA parameters for LGCD region.}
	...
	\vspace{0.2cm}
	\cventry{Jan 2015 -- Oct 2017}{Member of a scientific project}{University of Silesia in Katowice}{}{}{Project leader: dr hab. Wojciech Dobiński, University of Silesia, Department of Earth Science.}
	\vspace{-0.05cm}
	\cvitem{\small Aug 2015- Sep 2015}{\small Participant of the Scientific Expedition to the Spitsbergen}
	\vspace{-0.1cm}
...
% \vspace{-0.35cm}
\section{Programming}
	\cvitemwithcomment{Python}{5 years of experience}{Obspy, Scipy, Numpy, Matplotlib, Pandas, Flask, SQLalchemy}
...
\section{Education}
	...
	\vspace{-0.05cm}
	\cvitem{Keywords}{HVSR, Local effects, Python, ObsPy,  Matlab, Git.}
	...
	\vspace{-0.05cm}
	\cvitem{Keywords}{Matlab, Monte Carlo Sampling, D-optimum solution.}  % arguments 3 to 6 can be left empty
